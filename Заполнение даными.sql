   ...
   values
	...
	'
        [
        {
            ...
            "id_employee_type"           : "main_1",
            "emp_phone_number"           : "89091231234",
            "date_of_employment"         : "2020-01-01",
            "name_store"                 : "Телефоны и запчасти",
            "emp_name"                   : "Петр",
            "emp_family"                 : "Петров",
            "emp_patronymic"             : "Петрович",
            "emp_login"                  : "main_1@krstore.da",
            "emp_password"               : "main_1rstore1212"
        },
        {
            "id_employee"                : "mg_1",
            ...
            "id_employee_type"           : "mngr_logistic_1",
            "emp_phone_number"           : "89191231234",
            "date_of_employment"         : "2020-01-02",
            "name_store"                 : "Телефоны и запчасти",
            "emp_name"                   : "Иван",
            "emp_family"                 : "Менеджеров",
            "emp_patronymic"             : "Иванович",
            "emp_login"                  : "mngr_1@krstore.da",
            "emp_password"               : "mngr_1rstore1212"
        }
        ]
        '::json
	)
...
insert into Order_ (phone_number, address, id_Client, id_Order_status)
select  jpr.phone_number, jpr.address, jpr.id_Client, jpr.id_Order_status
from Order_json j
